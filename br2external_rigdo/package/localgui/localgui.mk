...
define LOCALGUI_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 $(@D)/css/style.css $(TARGET_DIR)/home/http/css/
	$(INSTALL) -D -m 0644 $(@D)/webgui_ru.xml $(TARGET_DIR)/home/http/
	$(INSTALL) -D -m 0644 $(@D)/webgui_en.xml $(TARGET_DIR)/home/http/
endef
